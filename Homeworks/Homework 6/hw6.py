...
def driver():
    [xstar, ier,its] = LazyNewton([1, 1], 1e-10, 1000)
    print([xstar, ier,its])

    [xstar, ier,its] = Newton([1, 1], 1e-10, 1000)
    print([xstar, ier,its])

    [xstar, ier, its] = Broyden([1, 1], 1e-10, 1000)
    print([xstar, ier, its])
    ...
    [xstar, ier,its] = LazyNewton([0, 0], 1e-10, 1000)
    print([xstar, ier,its])

    [xstar, ier,its] = Newton([0, 0], 1e-10, 1000)
    print([xstar, ier,its])

    [xstar, ier, its] = Broyden([0, 0], 1e-10, 1000)
    print([xstar, ier, its])
